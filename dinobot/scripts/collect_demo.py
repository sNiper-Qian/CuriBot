...
global_min_robot_state = np.array([np.inf]*10)
global_max_robot_state = np.array([-np.inf]*10)
        ...
        for traj in range(num_trajectories):
            ...
            for wp in env.abs_waypoints:
                ...
                if np.array_equal(goal_pose, GRASP_CODE):
                    ...
                    # Approach the object
                    actions, images_xz, images_yz, images_xy, images_wrist, robot_states = env.approach_pose(env, goal_pose, max_step=0.2)
