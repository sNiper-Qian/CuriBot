...
class PPO:
    ...
    def process_env_step(self, rewards, dones, infos):
        ...
        if self.rnd:
            ...
            # print(f"Extrinsic rewards: {self.transition.rewards}")
            # print(f"Intrinsic rewards: {self.intrinsic_rewards}")
    ...
    def update(self):  # noqa: C901
        ...
        return mean_value_loss, mean_surrogate_loss, mean_entropy, mean_rnd_loss
